...
# TODO https://web3py.readthedocs.io/en/stable/examples.html#contract-unit-tests-in-python
...
from package.web3_functions import get_rounded_amount, approve


class MyTestCase(TestCase):
    def setUp(self):
        Chain(const.CHAIN_ROPSTEN)
        Chain.web3 = Web3(EthereumTesterProvider())
    ...
    def test_get_rounded_amount(self):
        amount = 1000000001
        units = "gwei"
        self.assertEqual(1.00, get_rounded_amount(amount, units))

    def test_approve(self):
        # token = Token("0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae")
        max_amount = None
        t = EthereumTester()
        wallet = t.get_accounts()[0]
        # print(Chain().get_w3().get_accounts())
        # approve(token, wallet, max_amount=None)
